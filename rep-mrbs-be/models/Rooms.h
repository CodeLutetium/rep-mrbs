...
class Rooms {
  public:
    ...
    /**  For column area_id  */
    /// Get the value of the column area_id, returns the default value if the
    /// column is null
    ...
    /**  For column sort_key  */
    /// Get the value of the column sort_key, returns the default value if the
    /// column is null
    ...
    /**  For column capacity  */
    /// Get the value of the column capacity, returns the default value if the
    /// column is null
    ...
    /// Get the value of the column admin_email, returns the default value if
    /// the column is null
  ...
  public:
    ...
    static const std::string &sqlForDeletingByPrimaryKey() {
        static const std::string sql =
            "delete from " + tableName + " where room_id = $1";
        return sql;
    }
